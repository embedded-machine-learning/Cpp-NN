...
class SumReduction {
  public:
    ...
    template <bool ContinueAfter = true, IsMatrixType InputMatrixType, IsMatrixType OutputMatrixType, IsBaseMatrixType BufferMatrixType, IsBaseMatrixType PermanentMatrixType>
    __attribute__((always_inline)) inline void operator()(const InputMatrixType             &Input,
                                                          ...
                                                          PermanentMatrixType               &permanent) const noexcept {
