...
std::ostream &operator<<(std::ostream &os, const T memory_location) {
    ...
    os << "MemoryLocation: {"
       ...
       << ", buffer_index: " << std::setw(field_width) << memory_location.buffer_index << ", buffer_size: " << std::setw(field_width) << memory_location.buffer_size<< ", buffer_minimum: " << std::setw(field_width) << memory_location.buffer_minimum
